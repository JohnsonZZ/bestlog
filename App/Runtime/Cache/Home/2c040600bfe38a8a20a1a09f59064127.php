...
<body>
    ...
    <div class="main bc"> 
		<img src="/bestlog/Public/images/service-top.jpg" alt="百事得宣传"  />
        ...
        <div class="main-content fl">
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><div class="goods">
				<a href="<?php echo U('Home/Service/goods/id/'.$val[id]);?>">
					<div class="image">
						<img src="/bestlog/Public/upload/image/<?php echo ($val[href]); ?>" alt="托盘" />
					</div>
					<p>价格面议</p>
					<div class="f14">
						<?php echo ($val['brief']); ?>
