...
<body>
    ...
    <div class="main bc"> 
		<img src="/bestlog/Public/images/case-top.jpg" alt="百事得宣传"  />
        ...
        <div class="main-content fl">
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><div class="case">
				<a href="<?php echo U('Home/Case/article/theme/'.$val[id]);?>"><img src="/bestlog/Public/upload/image/<?php echo ($val[href]); ?>" width="180px" height="130px"/></a>
				<div class="content">
